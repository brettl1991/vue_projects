...
const facts = ref([
  {
    ...
    description: `I am incredibly small and fast! My core library is only around 30KB, so
        I won't slow you down.`,
  },
  {
    adjective: "Approachable",

    description: `Easy to learn and use, even for beginners. I have a gentle learning
        curve, clear documentation, and a supportive community.`,
  },
  {
    adjective: "Versatile",

    description: `I can handle everything from simple interactive elements to complex
